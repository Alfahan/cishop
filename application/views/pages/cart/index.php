        ...
        <div class="card-body">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <p><img src="<?= $row->image ? base_url("images/product/$row->image") : base_url("images/product/default.jpg") ?>" alt="" height="50">
                ...
                <td>
                  <form action="<?= base_url("cart/update/$row->id") ?>" method="POST">
                    ...
                    <div class="input-group">
                      <input name="qty" type="number" class="form-control" value="<?= $row->qty ?>" >
                ...
                <td>
                  <form action="<?= base_url("cart/delete/$row->id") ?>" method="POST" >
                    <input type="hidden" name="id" value="<?= $row->id ?>">
                    <button class="btn btn-danger" type="submit" onclick="return confirm('Apa yakin data barang ini akan dihapus?')"><i class="fas fa-trash"></i></button>
                  </form>
                </td>
              </tr>
              <?php endforeach ?>
