                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <span class="float-right">
                      Urutan Harga : <a href="<?= base_url("shop/sortby/asc")?>" class="badge badge-primary">Termurah</a>| Urutan Harga : <a href="<?= base_url("shop/sortby/desc")?>" class="badge badge-primary">Termahal</a>  
                    </span>
                  </div>
                </div> 
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    <h5 class="card-tittle"><?= $row->product_title ?> </h5>
